...
public class IntegerToRoman {
    ...
    public static String convert(int number) throws Exception {
        ...
        if (number < 1) {
            throw new Exception("Il numero deve essere superiore o uguale a 1");
        }
        if (number > 3000) {
            throw new Exception("Il codice non assicura la corretta esecuzione con un numero superiore a 3000");
        }
